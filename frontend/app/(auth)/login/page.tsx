    ...
    <main className="relative w-full min-h-screen">
      ...
      <div className="relative z-10 flex w-full min-h-screen items-center justify-center p-4">
        <div className="flex flex-col items-center justify-center w-full max-w-md">
          ...
          <section className="w-full p-4 md:p-6 md:px-8 bg-[rgba(20,20,20,0.85)] backdrop-blur-xl rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.5)] border-2 border-[#4fdfff] animate-[fadeIn_0.5s_ease]">
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-white font-bold tracking-widest text-base md:text-lg">{t("auth.login.title")}</h3>
            </div>
