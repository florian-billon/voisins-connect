...
export default function ServerSidebar({ servers, selectedServer, friends, user, onSelectServer, onShowProfile, onNavigateDMs, onOpenFriendDM }: Props) {
  ...
  return (
    <aside className={`hidden lg:flex w-[72px] bg-[rgba(26,42,58,0.95)] border-r border-[#5b8cff]/20 flex-col items-center py-3 gap-2 transition-all duration-300 flex-shrink-0`}>
      <button
        type="button"
